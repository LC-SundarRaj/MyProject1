...
public class AppConfig {
	...
	public DataSource ds() {
		...
		md.setDatabaseName(env.getProperty("db.mysql.driver"));
		md.setUrl(env.getProperty("db.mysql.url"));
		md.setUser(env.getProperty("db.mysql.user"));
		md.setPassword(env.getProperty("db.mysql.password"));
		return md;
	}
	...
	//6.AActivate Common Multipart File
	@Bean
